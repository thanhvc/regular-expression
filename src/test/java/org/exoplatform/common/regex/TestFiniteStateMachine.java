 ...
 * @date 7/5/11
 */
public class TestFiniteStateMachine extends TestCase
{

   public void testRecognizeSimplePattern()
   {
      State state_0, state_1, state_2, state_3, state_4, state_5, final_state;
      ...
      FiniteStateMachine stateMachine = new FiniteStateMachine(state_0);

      assertTrue(stateMachine.accept("hoangisaneXoer!"));
      stateMachine.reset();
      assertTrue(stateMachine.accept("hoangisaneXklmnoer!"));
      stateMachine.reset();
      assertFalse(stateMachine.accept("hoangisaneXoreXoe!"));
      stateMachine.reset();
      assertFalse(stateMachine.accept("hoangisaneX  oer"));
